...
exports.dashboardSnapshotSeed = exports.dashboardStatsSeed = exports.scheduleSeed = exports.practiceSetSeed = exports.courseProgressSeed = void 0;
exports.courseProgressSeed = [
    {
        id: 'english',
        title: '英语一真题精讲营',
        category: '公共课',
...
exports.dashboardSnapshotSeed = {
    userName: '张同学',
    stats: exports.dashboardStatsSeed,
    courses: exports.courseProgressSeed,
    practiceSets: exports.practiceSetSeed,
    schedule: exports.scheduleSeed,
    recommendation: '结合你的练习记录，建议本周重点回顾线性代数特征值章节，并安排一次政治时事热点速记。周末尝试进行一次 3 小时完整模拟，提前适应考试节奏。',
};

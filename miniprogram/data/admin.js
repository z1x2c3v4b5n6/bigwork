...
exports.adminStatisticsSeed = exports.adminForumPostsSeed = exports.adminForumTopicsSeed = exports.adminMaterialsSeed = exports.adminCoursesSeed = exports.adminMajorsSeed = exports.adminUsersSeed = exports.adminSettingsSeed = exports.adminDashboardNote = exports.adminAdministratorsSeed = exports.adminAuditLogSeed = exports.adminStudentProgressSeed = exports.adminTasksSeed = exports.adminMetricsSeed = exports.adminReferenceSites = void 0;
exports.adminReferenceSites = [
    {
        name: '研招网复试与调剂公告',
...
exports.adminStudentProgressSeed = [
    {
        id: 1001,
        name: '李晨',
        university: '北京大学软件工程',
...
exports.adminAdministratorsSeed = ['示例管理员（文案组）', '示例管理员（教研组）'];
exports.adminDashboardNote = '当前展示为示例数据，待接入真实数据库后即可查看实时后台指标。';
exports.adminSettingsSeed = {
    platform_name: '研途备考管理后台（示例）',
    support_email: 'support@example.com',
    security_note: '示例提示：请在正式环境中配置双因素认证与访问控制策略。',
};
exports.adminUsersSeed = [
    {
        id: 3001,
        username: 'demo_admin',
        displayName: '示例管理员',
